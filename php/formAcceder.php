...
<body class="bg-gray-100 h-screen flex flex-col items-center"> <!-- body -->
...
<!-- container -->
<div class="w-full h-full flex flex-col justify-center items-center flex-grow mt-2 space-y-8"> 
    <!-- formulario -->
  <div class="w-1/4 bg-white rounded-3xl p-12 shadow-lg text-center"> 
    <h1 class="mb-12 text-gray-800 text-bold text-2xl">Acceder</h1>
    <form action="./login.php" method="post">
      <div class="mb-6">
        <label for="usuario" class="block mb-2">Usuario:</label>
        <input type="text" id="usuario" name="usuario" required class="w-full p-2 border border-gray-300 rounded">
      </div>
      <div class="mb-6">
        <label for="contrasena" class="block mb-2">Contraseña:</label>
        <input type="password" id="contrasena" name="contrasena" required class="w-full p-2 border border-gray-300 rounded-md">
      </div>
      <div>
        <input type="submit" value="Acceder" class=" text-white mt-4 px-4 py-2 rounded-xl cursor-pointer bg-gray-900 hover:scale-110 hover:bg-gray-800 transition">
      </div>
    </form>
  </div> 
  <!-- fin de formulario -->
  ...
  <div class="w-1/4 bg-white rounded-lg p-6 shadow-lg text-center">
    <a href="./formInscripcion.php" class=" bg-gray-900 hover:scale-110 hover:bg-gray-800 transition text-white rounded-xl shadow-xl py-2 px-4">Registro</a>
  </div>

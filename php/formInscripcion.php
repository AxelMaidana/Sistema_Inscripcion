...
<!-- Formulario -->
<div class="w-full flex justify-center items-center flex-grow mt-10"> <!-- container -->
  <div class="w-1/4 bg-white rounded-lg p-6 shadow-lg text-center"> <!-- formulario -->
    <h1 class="mb-12 text-gray-800 text-bold text-2xl">Formulario de Inscripción</h1>
    <form action="./inscribir.php" method="post">
      <div class="mb-6">
        <label for="nombre" class="block mb-2">Nombre:</label>
        <input type="text" id="nombre" name="nombre" required class=" w-64 p-2 border border-gray-300 rounded">
      </div>
      <div class="mb-6">
        <label for="apellido" class="block mb-2">Apellido:</label>
        <input type="text" id="apellido" name="apellido" required class="w-64 p-2 border border-gray-300 rounded-md">
      </div>
      <div class="mb-6">
        <label for="dni" class="block mb-2">Dni:</label>
        <input type="number" id="dni" name="dni" required class="w-64 p-2 border border-gray-300 rounded-md">
      </div>
      <div>
        <input type="submit" value="Inscribir" class="bg-green-500 text-white px-4 py-2 rounded cursor-pointer hover:bg-green-600">
      </div>
    </form>
